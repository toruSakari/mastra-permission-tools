...
export interface IPermissionStore {
  ...
  setPermission(key: string, granted: boolean, expiresIn?: string, metadata?: Record<string, any>): Promise<void>;
...
export class MemoryPermissionStore implements IPermissionStore {
   ...
   * @param now 現在時刻
   */
  private calculateExpiresAt(expiresIn: string, now: number): number | undefined {
    switch (expiresIn) {
      case 'once':
