...
describe('security-levels', () => {
  ...
  describe('compareSecurityLevels', () => {
    it('should compare security levels correctly', () => {
      expect(compareSecurityLevels(SecurityLevel.HIGH, SecurityLevel.LOW)).toBeGreaterThan(0);
      expect(compareSecurityLevels(SecurityLevel.LOW, SecurityLevel.HIGH)).toBeLessThan(0);
      expect(compareSecurityLevels(SecurityLevel.MEDIUM, SecurityLevel.MEDIUM)).toBe(0);
    });

    it('should handle undefined values', () => {
      expect(compareSecurityLevels(undefined, SecurityLevel.LOW)).toBeLessThan(0);
      expect(compareSecurityLevels(SecurityLevel.LOW, undefined)).toBeGreaterThan(0);
    });
  });

  describe('getHigherSecurityLevel', () => {
    it('should return the higher security level', () => {
      expect(getHigherSecurityLevel(SecurityLevel.LOW, SecurityLevel.HIGH)).toBe(SecurityLevel.HIGH);
      expect(getHigherSecurityLevel(SecurityLevel.CRITICAL, SecurityLevel.MEDIUM)).toBe(SecurityLevel.CRITICAL);
    });

    it('should handle undefined values', () => {
      expect(getHigherSecurityLevel(undefined, SecurityLevel.HIGH)).toBe(SecurityLevel.HIGH);
      expect(getHigherSecurityLevel(SecurityLevel.LOW, undefined)).toBe(SecurityLevel.LOW);
      expect(getHigherSecurityLevel(undefined, undefined)).toBe(SecurityLevel.MEDIUM);
    });
  });
  ...
  describe('getSecurityLevelDisplayName', () => {
    it('should return correct display names', () => {
      ...
      expect(getSecurityLevelDisplayName(SecurityLevel.CRITICAL)).toBe('Critical');
    });
  });
  ...
  describe('parseSecurityLevel', () => {
    ...
    it('should throw error for invalid strings', () => {
      expect(() => parseSecurityLevel('invalid')).toThrow('Invalid security level: invalid');
    });
  });
